        ...
        const fetchSingleJob = async () => {
            try {
                ...
                if (res.data.success) {
                    ...
                    setIsApplied(res.data.job.applications.some(application=>application.applicant == user?._id))// Ensure the state is in synce with fetched data
                }
    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            <div className="flex items-center justify-between">
                ...
                <Button onClick={isApplied ? null : applyJobHandler} disabled={isApplied} className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-pointer-not-allowed' :
