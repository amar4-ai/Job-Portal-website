            ...
            <Dialog open={open}>
                <DialogContent className='sm:max-w-[425]' onInteractOutside={() => setOpen(false)}>
                    ...
                    <form onSubmit={submitHandler}>
                        ...
                        <DialogFooter>
                            {
                                loading ? <Button className="w-full my-4"><Loader2 className="mr-2 h-2 w-4 animate-spin" />Please Wait</Button> : <Button type="submit" className="w-full my-4">Upadte</Button>
